...
def sendEmailNonExistingUser(courseName, email, username, password):
    send_mail('You Have Been Added To ' + courseName, 
              'Hello, \n\nYou now have access to ' + courseName
               ...
               '\n\nOnce logged in, please edit your account information. You can do so by simply clicking on the greeting message "Hi No-Credential!" then click on the "Edit Account" option from the drop-down menu. You will then be redirected to a page where you can edit your account information.' + 
               '\n\nUSERNAME: ' + username + '\nPASSWORD: ' + password + '\nLINK: http://127.0.0.1:8000', 
              from_email=settings.EMAIL_HOST_USER, 
