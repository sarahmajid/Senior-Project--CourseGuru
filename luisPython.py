...
##
##query = "What is the late policy for this class?"
##
##try:
##	r = requests.get('https://westus.api.cognitive.microsoft.com/luis/v2.0/apps/6059c365-d88a-412b-8f33-d7393ba3bf9f?subscription-key=c574439a46e64d8cb597879499ccf8f9&verbose=true&timezoneOffset=-300&q=%s' % query)
##	#print(r.json())
##	jsonTxt = json.loads(r.text)
##	print(jsonTxt['topScoringIntent']['intent'])
##	print(jsonTxt['entities'])
##	#for x in jsonTxt:
